...
from invest_bot.dashboard.streamlit_backtest_history import (
    BACKTEST_HISTORY_NONE_OPTION,
    BACKTEST_HISTORY_SELECTION_KEY,
    BACKTEST_HISTORY_STRATEGY_FILTER_KEY,
    BACKTEST_HISTORY_SYMBOL_FILTER_KEY,
    filter_backtest_history_entries as _filter_backtest_history_entries,
    history_text as _history_text,
    load_backtest_history_entries as _load_backtest_history_entries,
    render_backtest_history_panel,
    sanitize_multiselect_state as _sanitize_session_multiselect_state,
)
...
def _render_backtest_history_panel(service: DashboardDataService) -> dict[str, object] | None:
    return render_backtest_history_panel(
        service,
        load_result=_load_backtest_history_result,
        st_api=st,
    )


def _sanitize_multiselect_state(key: str, options: list[str], fallback: list[str]) -> None:
    _sanitize_session_multiselect_state(st.session_state, key, options, fallback)
