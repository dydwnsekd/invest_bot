...
- 2026-09-15 통합 검토에서 날짜 없는 상세 수급에 파일명 날짜를 사용하는 경로와 CSV 숫자형 날짜 파싱 결함을 확인했습니다. 실제 거래일이 있는 수급 summary 연결 수정은 다음 순차 작업으로 대기 중입니다. 주말·휴일 요청이 실패할 수 있어 해당 경로는 아직 검증 완료로 보지 않습니다.
