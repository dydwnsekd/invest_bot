...
## 최근 세션 업데이트 (2026-09-19)

- [x] 대시보드 snapshot 재조회 축소, rerun 범위 frame 재사용, 백테스트 이력 UI 분리
- [x] 정기 수집 실패·재시작·후속 완료 표시 회귀 보완
- [x] 격리된 기본 테스트 `390 passed, 1 deselected` (기존 Alembic 경고 6건)
- [ ] 사용자 변경 검토 및 커밋 — 현재 작업 폴더에만 반영, 커밋·push하지 않음

상세 변경과 확인 순서는 [대시보드 검토본](../operations/session_reports/2026-09-19_dashboard.md)에 기록한다. 아래 날짜별 상태는 당시 기록이다.
