...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("listed_shares", sa.Numeric(precision=20, scale=4), nullable=True),
        sa.Column("par_value", sa.Numeric(precision=20, scale=4), nullable=True),
        sa.Column("settlement_month", sa.String(length=16), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("symbol", sa.String(length=12), nullable=False),
        sa.Column("trade_date", sa.Date(), nullable=False),
        sa.Column("investor_name", sa.String(length=120), nullable=False),
        sa.Column("buy_amount", sa.Numeric(precision=20, scale=4), nullable=True),
        sa.Column("sell_amount", sa.Numeric(precision=20, scale=4), nullable=True),
